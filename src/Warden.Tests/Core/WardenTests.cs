...
namespace Warden.Tests.Core
{
    ...
    public class when_initializing_without_configuration : Warden_specs
    {
        ...
        It should_have_a_specific_reason =  () => Exception.Message.ShouldContain("Warden configuration has not been provided.");
    }
    ...
    public class when_initializing_with_configuration : Warden_specs
    {
        ...
        It should_create_new_warden_instance = () => Warden.ShouldNotBeNull();
    }
