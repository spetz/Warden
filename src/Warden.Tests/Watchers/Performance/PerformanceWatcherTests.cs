...
namespace Warden.Tests.Watchers.Performance
{
    ...
    public class when_initializing_without_configuration : PerformanceWatcher_specs
    {
        ...
        It should_have_a_specific_reason = () => Exception.Message.ShouldContain("Performance Watcher configuration has not been provided.");
    }
    ...
    public class when_invoking_execute_async_method_with_valid_configuration : PerformanceWatcher_specs
    {
        ...
        It should_have_check_result_of_type_performance = () => PerformanceCheckResult.ShouldNotBeNull();

        It should_have_set_values_in_performance_check_result = () =>
        {
            PerformanceCheckResult.WatcherName.ShouldNotBeEmpty();
            PerformanceCheckResult.WatcherType.ShouldNotBeNull();
            PerformanceCheckResult.ResourceUsage.ShouldNotBeNull();
            PerformanceCheckResult.ResourceUsage.Cpu.ShouldEqual(CpuUsage);
            PerformanceCheckResult.ResourceUsage.Ram.ShouldEqual(RamUsage);
        };
    }
