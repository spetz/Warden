...
namespace Sentry.Core
{
    ...
    public class WatcherHooksConfiguration
    {
        ...
        private readonly ISet<Expression<Action<ISentryCheckResult>>> _onSuccess = new HashSet<Expression<Action<ISentryCheckResult>>>();
        private readonly ISet<Expression<Func<ISentryCheckResult, Task>>> _onSuccessAsync = new HashSet<Expression<Func<ISentryCheckResult, Task>>>();
        private readonly ISet<Expression<Action<ISentryCheckResult>>> _onFirstSuccess = new HashSet<Expression<Action<ISentryCheckResult>>>();
        private readonly ISet<Expression<Func<ISentryCheckResult, Task>>> _onFirstSuccessAsync = new HashSet<Expression<Func<ISentryCheckResult, Task>>>();
        private readonly ISet<Expression<Action<ISentryCheckResult>>> _onFailure = new HashSet<Expression<Action<ISentryCheckResult>>>();
        private readonly ISet<Expression<Func<ISentryCheckResult, Task>>> _onFailureAsync = new HashSet<Expression<Func<ISentryCheckResult, Task>>>();
        private readonly ISet<Expression<Action<ISentryCheckResult>>> _onFirstFailure = new HashSet<Expression<Action<ISentryCheckResult>>>();
        private readonly ISet<Expression<Func<ISentryCheckResult, Task>>> _onFirstFailureAsync = new HashSet<Expression<Func<ISentryCheckResult, Task>>>();
        private readonly ISet<Expression<Action<ISentryCheckResult>>> _onCompleted = new HashSet<Expression<Action<ISentryCheckResult>>>();
        private readonly ISet<Expression<Func<ISentryCheckResult, Task>>> _onCompletedAsync = new HashSet<Expression<Func<ISentryCheckResult, Task>>>();
